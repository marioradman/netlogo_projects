...
to plot_optima
  ...
  [
    ...
    plot count bees with [quality > 1.1 and pcor > (max-pycor / 2)]
  ]
  [
    set-current-plot-pen "local"
    plot count bees with [quality > 1.1 and pycor < (max-pycor / 2)]
  ]
...
100 / population_size * (count bees with [quality > 1.1 and pycor > (max-pycor / 2)])
17
1
11
